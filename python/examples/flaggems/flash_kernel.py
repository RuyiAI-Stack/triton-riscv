...
# @triton.autotune and @triton.heuristics removed;
# kernel params BLOCK_M, BLOCK_N, BLOCK_K, num_warps, num_stages, PRE_LOAD_V, IS_EVEN_MN
# are passed as tl.constexpr via cfg_params from flash_api.py
@triton.jit
...
# @triton.heuristics removed; kernel params BLOCK_M, BLOCK_N, BLOCK_K, num_warps,
# num_stages, PRE_LOAD_V, IS_EVEN_MN, blocks_per_split are passed as tl.constexpr
@triton.jit

...
def _fill_cauchy_contiguous(out, N, median, sigma, *, generator=None):
    def grid_fn(meta):
    ...
    cauchy_kernel[grid_fn](
        out, N, median, sigma, philox_seed, philox_offset, BLOCK=BLOCK
    )
...
def cauchy_(self, median=0, sigma=1, *, generator=None):
    ...
    if not self.is_contiguous():
        ...
        _fill_cauchy_contiguous(work, N, median, sigma, generator=generator)
        self.copy_(work)
        return self

    _fill_cauchy_contiguous(self, N, median, sigma, generator=generator)
    return self

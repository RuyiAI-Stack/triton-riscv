...
// CHECK:           %[[MAXSI_0:.*]] = arith.maxsi %[[MINSI_0]], %[[CONSTANT_6]] : index
// CHECK:           %[[SUBI_0:.*]] = arith.subi %[[MAXSI_0]], %[[CONSTANT_6]] : index
...
// CHECK:           %[[SUBI_1:.*]] = arith.subi %[[MAXSI_1]], %[[CONSTANT_5]] : index
...
// CHECK:           %[[CMPI_0:.*]] = arith.cmpi slt, %[[MINSI_2]], %[[CONSTANT_2]] : index
// CHECK:           %[[CMPI_1:.*]] = arith.cmpi slt, %[[MINSI_3]], %[[CONSTANT_1]] : index
// CHECK:           %[[ORI_0:.*]] = arith.ori %[[CMPI_0]], %[[CMPI_1]] : i1
// CHECK:           scf.if %[[ORI_0]] {
// CHECK:             linalg.fill ins(%[[CONSTANT_0]] : bf16) outs(%[[ALLOC_0]] : memref<128x256xbf16>)
// CHECK:           }

...
// CHECK:           %[[FOR_0:.*]]:2 = scf.for %[[VAL_0:.*]] = %[[CONSTANT_0]] to %[[CONSTANT_1]] step %[[CONSTANT_2]] iter_args(%[[VAL_1:.*]] = %[[FILL_0]], %[[VAL_2:.*]] = %[[INDEX_CAST_0]]) -> (tensor<128x128xf32>, index) {
...
// CHECK:           %[[ADDI_2:.*]] = arith.addi %[[INDEX_CAST_3]], %[[CONSTANT_3]] : index

...
// CHECK:             %[[INDEX_CAST_1:.*]] = arith.index_cast %[[INDEX_CAST_0]] : i32 to index
// CHECK:             %[[ADDI_6:.*]] = arith.addi %[[VAL_4]], %[[INDEX_CAST_1]] : index
// CHECK:             scf.yield %[[ADDI_1]], %[[ADDI_0]], %[[ADDI_2]], %[[ADDI_6]], %[[ADDI_3]] : index, index, index, index, index
// CHECK:           }
// CHECK:           return
// CHECK:         }
  tt.func @kernel(

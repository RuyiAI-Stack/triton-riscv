...
// CHECK:           %[[CONSTANT_4:.*]] = arith.constant dense<4> : tensor<64xi32>
...
// CHECK:           %[[CONSTANT_10:.*]] = arith.constant -1.000000e+00 : f32
...
// CHECK:           %[[FOR_0:.*]]:3 = scf.for %[[VAL_0:.*]] = %[[CONSTANT_9]] to %[[CONSTANT_7]] step %[[CONSTANT_8]] iter_args(%[[VAL_1:.*]] = %[[CONSTANT_3]], %[[VAL_2:.*]] = %[[MAKE_RANGE_0]], %[[VAL_3:.*]] = %[[MAKE_RANGE_0]]) -> (i32, tensor<64xi32>, tensor<64xi32>)  : i32 {
// CHECK:             %[[DIVSI_0:.*]] = arith.divsi %[[VAL_2]], %[[CONSTANT_4]] : tensor<64xi32>
...
// CHECK:             %[[FOR_1:.*]] = scf.for %[[VAL_4:.*]] = %[[CONSTANT_1]] to %[[CONSTANT_2]] step %[[CONSTANT_0]] iter_args(%[[VAL_5:.*]] = %[[EMPTY_0]]) -> (tensor<64xf32>) {
...
// CHECK:               %[[SELECT_0:.*]] = arith.select %[[EXTRACT_1]], %[[LOAD_0]], %[[CONSTANT_10]] : f32
...
// CHECK:             }
// CHECK:             %[[ADDI_0:.*]] = arith.addi %[[VAL_1]], %[[CONSTANT_5]] : i32
// CHECK:             %[[ADDI_1:.*]] = arith.addi %[[VAL_2]], %[[CONSTANT_6]] : tensor<64xi32>
// CHECK:             %[[ADDI_2:.*]] = arith.addi %[[VAL_3]], %[[CONSTANT_6]] : tensor<64xi32>

...
// CHECK:           %[[CONSTANT_1:.*]] = arith.constant 20480 : index
...
// CHECK:           %[[MAKE_TPTR_0:.*]] = tts.make_tptr %[[ARG0]] to sizes: [1024], strides: {{\[}}%[[CONSTANT_0]]], offsets: {{\[}}%[[ADDI_0]]], shape: [0], order: [] : <bf16> to tensor<1024x!tt.ptr<bf16>>

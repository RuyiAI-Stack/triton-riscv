...
// CHECK:           %[[REINTERPRET_CAST_0:.*]] = memref.reinterpret_cast %[[ARG0]] to offset: {{\[}}%[[ADDI_1]]], sizes: [4, 256], strides: [1, 6] : memref<*xbf16> to memref<4x256xbf16, strided<[1, 6], offset: ?>>
// CHECK:           %[[INDEX_CAST_2:.*]] = arith.index_cast %[[ARG2]] : i32 to index
// CHECK:           %[[INDEX_CAST_3:.*]] = arith.index_cast %[[ARG3]] : i32 to index
// CHECK:           %[[ADDI_2:.*]] = arith.addi %[[INDEX_CAST_2]], %[[INDEX_CAST_3]] : index
// CHECK:           %[[ADDI_3:.*]] = arith.addi %[[ADDI_2]], %[[CONSTANT_0]] : index
// CHECK:           %[[REINTERPRET_CAST_1:.*]] = memref.reinterpret_cast %[[ARG1]] to offset: {{\[}}%[[ADDI_3]]], sizes: [4, 256], strides: [1, 6] : memref<*xbf16> to memref<4x256xbf16, strided<[1, 6], offset: ?>>

...
// CHECK:           %[[FOR_0:.*]]:2 = scf.for %[[VAL_0:.*]] = %[[CONSTANT_0]] to %[[CONSTANT_1]] step %[[CONSTANT_2]] iter_args(%[[VAL_1:.*]] = %[[FILL_0]], %[[VAL_2:.*]] = %[[INDEX_CAST_0]]) -> (tensor<1024xf32>, index) {
// CHECK:             %[[REINTERPRET_CAST_0:.*]] = memref.reinterpret_cast %[[ARG1]] to offset: {{\[}}%[[VAL_2]]], sizes: [1024], strides: [1] : memref<*xf32> to memref<1024xf32, strided<[1], offset: ?>>
...
// CHECK:             %[[GENERIC_1:.*]] = linalg.generic {indexing_maps = [#[[$ATTR_0]], #[[$ATTR_0]], #[[$ATTR_0]]], iterator_types = ["parallel"]} ins(%[[VAL_1]], %[[GENERIC_0]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[VAL_1]] : tensor<1024xf32>) {
...
// CHECK:             %[[ADDI_0:.*]] = arith.addi %[[VAL_2]], %[[INDEX_CAST_2]] : index
// CHECK:             scf.yield %[[GENERIC_1]], %[[ADDI_0]] : tensor<1024xf32>, index
// CHECK:           }
...
// CHECK:           bufferization.materialize_in_destination %[[VAL_8:.*]]#0 in writable %[[REINTERPRET_CAST_1]] : (tensor<1024xf32>, memref<1024xf32, strided<[1], offset: ?>>) -> ()
// CHECK:           return
// CHECK:         }
module {
